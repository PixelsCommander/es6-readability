...
module.exports.setCleanRules = (rules) => {
  cleanRules = rules;
};
 ...
 * @return void
 **/
var prepDocument = module.exports.prepDocument = (document) => {
 ...
 * @return Element
 **/
var grabArticle = module.exports.grabArticle = (document, preserveUnlikelyCandidates) => {
  /**
